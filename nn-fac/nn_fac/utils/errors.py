...
class ArgumentException(BaseException): pass   #we inherit from BaseException (not Exception)
class InvalidRanksException(ArgumentException): pass
class CustomNotEngouhFactors(ArgumentException): pass #must be CustomNotEnoughFactors but kept for compatibility
